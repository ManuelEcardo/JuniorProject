...
//LOCAL HOSTS:
const String localhost= 'http://10.0.2.2:8000'; //'''https://cf75-217-20-208-37.eu.ngrok.io';  //local host to connect, it's temporary and will be removed later.
...
const String allUnits= 'unitsAll'; //get all units for a language

const String lessons= 'lessons'; //get lessons

const String questions= 'questions'; //get questions
...
const String leaderboards= 'leadboards'; //Get Leaderboards

const String favourites='favourites'; //Get User Favourites List of Words.
...
const String getTip='daily'; //Getting a Tip.
...
const String youtubeVideosSearch='search';