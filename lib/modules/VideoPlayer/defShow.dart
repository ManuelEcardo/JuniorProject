...
class _DefinitionShowState extends State<DefinitionShow> {
  ...
  Widget itemBuilder(WordCubit cubit, MerriamModel model, FavouritesModel? favouritesModel, AppCubit appCubit)
  {
    return BlocListener<AppCubit,AppStates>(
        listener: (context,state)
        {
          if(state is AppWordChangeTrueFav)
            {
              print('word should be filled');
            }
          if(state is AppWordChangeFalseFav)
            {
              print('word should be unfilled');
            }
        },
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(
                      ...
                      appCubit.isWordFav ? Icons.favorite : Icons.favorite_border_outlined, size: 30, color: Colors.redAccent,),
